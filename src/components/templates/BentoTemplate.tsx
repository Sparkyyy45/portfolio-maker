...
export default function BentoTemplate({ data, isDemo = false, onSubmitMessage }: PortfolioPreviewProps) {
  const {
  ...
  const themeStyles = {
    ...
    nord: {
      ...
      border: "border-[#4C566A]/60",
      cardBorder: "border-[#4C566A]",
      cardBg: "bg-[#3B4252]/60 hover:bg-[#3B4252]/90 hover:border-[#88C0D0]/30 hover:shadow-lg",
      cardSimpleBg: "bg-[#3B4252]/30 hover:bg-[#3B4252]/50 hover:border-[#88C0D0]/20",
      pillBg: "bg-[#434C5E] text-[#D8DEE9] border border-[#4C566A]",
      inputBg: "bg-[#3B4252] text-[#D8DEE9] border-[#4C566A] focus:border-[#88C0D0] focus:ring-[#88C0D0]",
      button: "bg-[#88C0D0] hover:bg-[#8FBCBB] text-[#2E3440] font-bold disabled:bg-[#4C566A]",
      textMuted: "text-[#969fac]",
      textDark: "text-[#E5E9F0]",
      textLight: "text-[#4C566A] font-bold",
      headingIcon: "text-[#88C0D0]/60",
      nav: "bg-[#2E3440]/90 border-b border-[#4C566A]/60 text-[#D8DEE9] hover:text-[#88C0D0]",
      footer: "border-t border-[#4C566A]/60 bg-[#2E3440] text-[#4C566A]",
      timelineDot: "border-[#4C566A] bg-[#2E3440] text-[#88C0D0]",
      timelineLine: "bg-[#4C566A]/60",
      leetBg: "bg-[#3B4252]/40 border-[#4C566A]/60",
      leetBarBg: "bg-[#4C566A]",
      leftCardBg: "bg-[#3B4252]/30 border border-[#4C566A]/60",
      greenPill: "bg-[#A3BE8C]/10 text-[#A3BE8C] border-[#A3BE8C]/25",
      greenPillDot: "bg-[#A3BE8C]",
      heatmapFilled: "bg-[#A3BE8C]",
      heatmapEmpty: "bg-[#3B4252]",
      sectionDivider: "border-[#4C566A]/60",
      skillCatLabel: "text-[#4C566A]",
    },
    dracula: {
      wrapper: "bg-[#282a36] text-[#f8f8f2]",
      border: "border-[#44475a]/60",
      cardBorder: "border-[#44475a]",
      cardBg: "bg-[#1d1f27]/60 hover:bg-[#1d1f27]/95 hover:border-[#ff79c6]/30 hover:shadow-xl",
      cardSimpleBg: "bg-[#1d1f27]/30 hover:bg-[#1d1f27]/50 hover:border-[#ff79c6]/20",
      pillBg: "bg-[#282a36] text-[#ff79c6] border border-[#44475a]",
      inputBg: "bg-[#1d1f27] text-[#f8f8f2] border-[#44475a] focus:border-[#ff79c6] focus:ring-[#ff79c6]",
      button: "bg-[#ff79c6] hover:bg-[#ff92df] text-[#282a36] font-bold disabled:bg-[#44475a]",
      textMuted: "text-[#a4a9c6]",
      textDark: "text-[#f8f8f2]",
      textLight: "text-[#6272a4] font-semibold",
      headingIcon: "text-[#ff79c6]/60",
      nav: "bg-[#282a36]/90 border-b border-[#44475a]/60 text-[#f8f8f2] hover:text-[#ff79c6]",
      footer: "border-t border-[#44475a]/60 bg-[#282a36] text-[#6272a4]",
      timelineDot: "border-[#44475a] bg-[#282a36] text-[#ff79c6]",
      timelineLine: "bg-[#44475a]/60",
      leetBg: "bg-[#1d1f27]/40 border-[#44475a]/60",
      leetBarBg: "bg-[#44475a]",
      leftCardBg: "bg-[#1d1f27]/30 border border-[#44475a]/60",
      greenPill: "bg-[#50fa7b]/10 text-[#50fa7b] border-[#50fa7b]/25",
      greenPillDot: "bg-[#50fa7b]",
      heatmapFilled: "bg-[#50fa7b]",
      heatmapEmpty: "bg-[#1d1f27]",
      sectionDivider: "border-[#44475a]/60",
      skillCatLabel: "text-[#6272a4]",
    },
    synthwave: {
      wrapper: "bg-[#180a2b] text-[#f0e6ff]",
      border: "border-[#ff007f]/20",
      cardBorder: "border-[#ff007f]/30",
      cardBg: "bg-[#24113a]/80 hover:bg-[#24113a] hover:border-[#ff007f]/50 hover:shadow-[0_0_20px_rgba(255,0,127,0.1)]",
      cardSimpleBg: "bg-[#24113a]/30 hover:bg-[#24113a]/50 hover:border-[#ff007f]/20",
      pillBg: "bg-[#2d1b4c] text-[#ff007f] border border-[#ff007f]/35",
      inputBg: "bg-[#24113a] text-[#f0e6ff] border-[#ff007f]/30 focus:border-[#39ff14] focus:ring-[#39ff14]",
      button: "bg-[#39ff14] hover:bg-[#5aff38] text-[#180a2b] font-black disabled:bg-[#2d1b4c]",
      textMuted: "text-[#b89eff]",
      textDark: "text-white",
      textLight: "text-[#ff007f]/70 font-semibold",
      headingIcon: "text-[#ff007f]/70",
      nav: "bg-[#180a2b]/90 border-b border-[#ff007f]/20 text-[#f0e6ff] hover:text-[#ff007f]",
      footer: "border-t border-[#ff007f]/20 bg-[#180a2b] text-[#ff007f]/50",
      timelineDot: "border-[#ff007f]/30 bg-[#180a2b] text-[#39ff14]",
      timelineLine: "bg-[#ff007f]/20",
      leetBg: "bg-[#24113a]/40 border-[#ff007f]/20",
      leetBarBg: "bg-[#2d1b4c]",
      leftCardBg: "bg-[#24113a]/30 border border-[#ff007f]/20",
      greenPill: "bg-[#39ff14]/10 text-[#39ff14] border-[#39ff14]/25",
      greenPillDot: "bg-[#39ff14]",
      heatmapFilled: "bg-[#39ff14]",
      heatmapEmpty: "bg-[#24113a]",
      sectionDivider: "border-[#ff007f]/20",
      skillCatLabel: "text-[#ff007f]/50",
    },
    latte: {
      wrapper: "bg-[#F5EBE6] text-[#5C4033]",
      border: "border-[#E6D4CB]/60",
      cardBorder: "border-[#E6D4CB]",
      cardBg: "bg-[#FCF9F7] hover:border-[#A75D5D]/40 hover:shadow-xs",
      cardSimpleBg: "bg-[#FCF9F7]/60 hover:bg-[#FCF9F7] hover:border-[#A75D5D]/20",
      pillBg: "bg-[#FCF9F7] text-[#5C4033] border border-[#E6D4CB]",
      inputBg: "bg-[#FCF9F7] text-[#5C4033] border-[#E6D4CB] focus:border-[#A75D5D] focus:ring-[#A75D5D]",
      button: "bg-[#A75D5D] hover:bg-[#C17A7A] text-[#FCF9F7] font-bold disabled:bg-[#DFCABF]",
      textMuted: "text-[#8B7365]",
      textDark: "text-[#3C2A21]",
      textLight: "text-[#A75D5D]/80 font-bold",
      headingIcon: "text-[#A75D5D]",
      nav: "bg-[#F5EBE6]/95 border-b border-[#E6D4CB] text-[#8B7365] hover:text-[#3C2A21]",
      footer: "border-t border-[#E6D4CB] bg-[#FCF9F7] text-[#8B7365]",
      timelineDot: "border-[#E6D4CB] bg-[#FCF9F7] text-[#A75D5D]",
      timelineLine: "bg-[#E6D4CB]/60",
      leetBg: "bg-[#FCF9F7]/50 border-[#E6D4CB]/60",
      leetBarBg: "bg-[#E6D4CB]",
      leftCardBg: "bg-[#FCF9F7]/40 border border-[#E6D4CB]/60",
      greenPill: "bg-emerald-50 text-emerald-700 border-emerald-250",
      greenPillDot: "bg-emerald-500",
      heatmapFilled: "bg-emerald-500",
      heatmapEmpty: "bg-[#FCF9F7]",
      sectionDivider: "border-[#FCF9F7]",
      skillCatLabel: "text-[#8B7365]/80",
    }
  };
